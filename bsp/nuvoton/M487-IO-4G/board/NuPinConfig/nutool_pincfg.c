...
{
    SYS->GPB_MFPL &= ~(SYS_GPB_MFPL_PB2MFP_Msk | SYS_GPB_MFPL_PB1MFP_Msk | SYS_GPB_MFPL_PB5MFP_Msk | SYS_GPB_MFPL_PB4MFP_Msk | SYS_GPB_MFPL_PB3MFP_Msk | SYS_GPB_MFPL_PB7MFP_Msk);
    SYS->GPB_MFPL |= (SYS_GPB_MFPL_PB2MFP_EMAC_RMII_CRSDV | SYS_GPB_MFPL_PB1MFP_EMAC_RMII_RXERR | SYS_GPB_MFPL_PB5MFP_EMAC_RMII_REFCLK | SYS_GPB_MFPL_PB4MFP_EMAC_RMII_RXD0 | SYS_GPB_MFPL_PB3MFP_EMAC_RMII_RXD1 | SYS_GPB_MFPL_PB7MFP_EMAC_RMII_TXEN);
    SYS->GPB_MFPH &= ~(SYS_GPB_MFPH_PB8MFP_Msk | SYS_GPB_MFPH_PB9MFP_Msk | SYS_GPB_MFPH_PB10MFP_Msk | SYS_GPB_MFPH_PB11MFP_Msk);
    SYS->GPB_MFPH |= (SYS_GPB_MFPH_PB8MFP_EMAC_RMII_TXD1 | SYS_GPB_MFPH_PB9MFP_EMAC_RMII_TXD0 | SYS_GPB_MFPH_PB10MFP_EMAC_RMII_MDIO | SYS_GPB_MFPH_PB11MFP_EMAC_RMII_MDC);
